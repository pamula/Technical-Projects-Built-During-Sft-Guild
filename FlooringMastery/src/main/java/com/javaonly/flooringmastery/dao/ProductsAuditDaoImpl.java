 ...
 * @author Prathima
 */
public class ProductsAuditDaoImpl  implements ProductsAuditDao{
    
    public static final String AUDIT_PRODUCTSFILE = "auditProduct.txt";
   public void writeAuditEntry(String entry) throws DataPersistenceException{
       ...
       try{
           ...
           out = new PrintWriter(new FileWriter(AUDIT_PRODUCTSFILE, true));
